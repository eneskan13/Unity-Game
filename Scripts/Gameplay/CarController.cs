...
public class CarController : MonoBehaviour
{
    ...
    [HideInInspector] public JointMotor2D motorBack;
    ...
    public float groundDistance = 50000.1f;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            GameManager.instance.mainNitro = Mathf.Clamp(GameManager.instance.mainNitro + 35, 0, GameManager.instance.MaxNitro);
